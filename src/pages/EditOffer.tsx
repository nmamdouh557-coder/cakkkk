...
const EditOffer: React.FC = () => {
      ...
      try {
        ...
        if (offer) {
          setFormData({
            ...
            startDate: offer.startDate ? parseISO(offer.startDate) : undefined,
            endDate: offer.endDate ? parseISO(offer.endDate) : undefined,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!id || !formData.brand || !formData.title || !formData.startDate || !formData.endDate) {
    ...
    try {
      ...
      alert(error.response?.data?.error || 'Failed to update offer. Check your permissions.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <Card className="border-none shadow-premium-lg overflow-hidden">
        ...
        <CardHeader className="p-8 pb-4">
          <CardTitle className="text-3xl font-black text-gray-900 tracking-tight">Edit offer</CardTitle>
          <CardDescription className="text-base">
            Modifying the promotional details for "{formData.title}"
          </CardDescription>
        </CardHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10">
              ...
              <div className="space-y-3">
                ...
                <Select value={formData.brand} onValueChange={(v: string) => setFormData({ ...formData, brand: v })}>
